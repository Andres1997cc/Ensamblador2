...
section .data
    pathDes db '/home/andres/Documents/arrayDes.txt',0
    pathOr db '/home/andres/Documents/arrayOr.txt',0
    newLine db '',10
...
readFileNum1:
    ...
    mov edx, 0x1FF
    int 80h
;inicializamos metodo de ordenamiento , y  ponemos los vlaores de puntero 0 y tamaño array
    mov esi,array
    mov edi,0
...
; condicion para ver si esta
    cmp cl,0
    jg initOrder

;termina proceso de ordenamiento
